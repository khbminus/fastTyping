...
// How to work with:
// 1) On server create an object of TextGenerator using filename of dictionary.txt
// 2) 1 line == 1 word, so in case of quotes etc you need to parse it later..??? you can use split method?
// 3) Use getTop k, to get k LINES of dictionary
